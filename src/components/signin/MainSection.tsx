  ...
  const googleLogin = useGoogleLogin({
    onSuccess: async (tokenResponse) => {
      ...
      try {
        ...
        sessionStorage.setItem("authToken", res.data.key);
...
=======
            ...
            <div className="pt-8 space-y-5">
              ...
              <Button
                variant="whitebg"
                size="xlg"
                className={`w-full justify-start gap-3 max-md:px-[16px] md:py-5 ${selectedMethod === "email"
                  ? "border border-blue-400 "
                  : "border border-neutral-gray-lightest"
                  }`}
                onClick={() =>
              ...
              <Button
                variant="whitebg"
                size="xlg"
                className={`w-full justify-start gap-3 max-md:px-[16px] md:py-5 ${window.innerWidth <= 768 && selectedMethod === "apple"
                  ? "border border-blue-400"
                  : "border border-neutral-gray-lightest"
                  }`}
                onClick={() =>
              ...
              <Button
                variant="whitebg"
                size="xlg"
                className={`w-full justify-start gap-3 max-md:px-[16px] md:py-5 ${window.innerWidth <= 768 && selectedMethod === "google"
                  ? "border border-blue-400"
                  : "border border-neutral-gray-lightest"
                  }`}
                onClick={() =>
