import { AnimateStaggerItem } from "@/components/ui/AnimateOnScroll";
  ...
  <section className="container max-w-[1110px] max-auto mb-[64px]">
   <div className="w-full">
    <div className="flex flex-wrap gap-4 md:gap-6">
     {/* Card */}
     <AnimateStaggerItem index={0} className="w-full md:w-[48%]">
      <div className="bg-[#EE3123] rounded-2xl overflow-hidden shadow flex w-full h-full">
     ...
     {/* Card (duplicate) */}
     <AnimateStaggerItem index={1} className="w-full md:w-[48%]">
      <div className="bg-[#054A86] rounded-2xl overflow-hidden shadow flex w-full h-full">
       <div className="flex w-full flex-col sm:flex-row items-stretch">
        <div className="flex-1 p-4 sm:p-6 flex flex-col gap-2 justify-start">
         <h3 className="text-white text-xl sm:text-2xl font-extrabold">
          Get the Dosta App
