    ...
    <footer className="bg-gray-900 text-white">
      <div className="px-4 sm:px-8 md:px-[165px] mx-auto py-12 max-w-[1440px]">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex flex-col sm:flex-row justify-start gap-2">
              {appBadges.map((badge, idx) => (
                <img key={idx} src={badge.src} alt={badge.alt} className="h-10 w-auto" />
              ))}
            </div>
          </div>
        </div>
        ...
        <div className="pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          {/* Chat Button */}
          <button className="fixed bottom-6 right-6 w-14 h-14 bg-red-500 rounded-full flex items-center justify-center shadow-lg hover:bg-red-600 transition-colors z-50">
