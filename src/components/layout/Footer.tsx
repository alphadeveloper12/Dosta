   ...
   <div className="px-4 sm:px-8 md:px-[165px] mx-auto py-12 max-w-[1440px]">
    ...
    <div className="pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
     ...
     <button
      ...
      className="absolute bottom-0 md:right-[165px] right-[16px] h-[44px] w-[88px] rounded-t-[8px]  bg-[#EE3123]  flex items-center justify-center shadow-lg hover:bg-red-600 transition-colors z-20 gap-[8px]">
