...
interface MenuProps {
 ...
 setDayPickupSlots?: React.Dispatch<
      ...
      <div className="flex md:flex-row justify-between flex-col gap-2 md:py-2 pt-4 items-center">
       {timeSlots.length > 0 && (
        <div className="flex items-center gap-3">
         <span className="text-[14px] font-[600] text-[#545563]">
          Pickup Time:
         </span>
         <select
          value={
           dayPickupSlots[`${weekNumber}-${currentDay}`] || defaultSlotId || ""
          }
          onChange={(e) => {
        ...
        <motion.div
         ...
         <div className="flex-1 py-4 space-y-4">
          <p className="text-gray-600 text-[16px] leading-[24px] font-[400]">
           Select one of your saved plans to load it into the calendar. This
           will overwrite any current selections.
          </p>
