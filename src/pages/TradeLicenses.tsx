    ...
    <div className="main-container py-8">
     ...
     <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mt-12 mb-20">
      {licenses.map((license, index) => (
       <AnimateStaggerItem key={license.id} index={index}>
        <div className="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 p-8 flex flex-col items-center text-center border border-gray-100 group">
