   ...
   <div className="main-container px-4 sm:px-6 lg:px-8">
    ...
    <div className="grid lg:grid-cols-3 gap-10">
     ...
     <div className="lg:col-span-2 space-y-8">
      {/* Card 1: Main Contact */}
      <AnimateStaggerItem index={0} direction="left">
      ...
      <AnimateStaggerItem index={1} direction="left">
       <div
     ...
     <div className="lg:col-span-1 space-y-8">
      {/* Location Card */}
      <AnimateStaggerItem index={0} direction="right">
      ...
      {/* Careers Card */}
      <AnimateStaggerItem index={1} direction="right">
