  ...
  return (
    <div className="bg-neutral-white border rounded-2xl p-6 md:p-8" style={{ border: "1px solid #EDEEF2" }}>
      <div className="flex items-center mb-6 gap-4">
        ...
        <h2 className="text-primary-text text-2xl font-bold">What's the Budget you have in Mind?</h2>
      </div>
          ...
          {budgetOptions.map((budget) => (
            <Button
              ...
              style={{
                ...
                padding: '16px',
                width: '245px',
                border: selectedBudget === budget.id ? '1px solid #054A86' : '1px solid #C7C8D2',
                display: 'flex',
            ...
            >
              <span style={{ fontWeight: '400', fontSize: '16px' }}>{budget.title}</span>
              <span style={{ fontWeight: '400', fontSize: '16px' }}>{budget.price}</span>
            </Button>
          ))}
        </div>
      </div>
      ...
      <div className="flex justify-between mt-8">
        ...
        <Button
          ...
          className={`bg-[#054A86] text-white hover:bg-[#054A86] hover:bg-opacity-70 ${!selectedBudget ? "cursor-not-allowed" : ""}`}
