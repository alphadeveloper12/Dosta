    ...
    try {
      ...
      if (guestCartData) {
        try {
          ...
          console.error("Signup Cart Sync Error:", syncErr);
        }
      }
      ...
      if (error?.response?.data) {
        ...
        if (typeof data === "string") errorMsg = data;
          ...
          errorMsg = Array.isArray(data.phone_number)
            ? data.phone_number[0]
            : data.phone_number;
        ...
        <div className="flex flex-col justify-between w-full max-w-[25rem] lg:min-h-full py-4">
          ...
          <div className="flex-grow flex flex-col justify-center">
            ...
            <div className="flex flex-col gap-3 mt-6">
              ...
              <button
                className={`w-full border ${currentStep === 1 ? "opacity-20 cursor-not-allowed" : "border-gray-300"
