...
const HeroSection = () => {
 ...
 return (
  <section className="relative hlo lg:min-h-[623px] sm:min-h-[512px] flex items-start justify-center py-8 sm:py-0 bg-primary-dark">
   ...
   <Slider {...sliderSettings} className="w-full">
    ...
    {[...Array(4)].map((_, index) => (
     <div
      ...
      <div className="w-full flex items-center justify-center gap-[80px] px-[24px] sm:px-[48px] md:px-[64px] py-[24px] sm:py-[32px]">
       <div className="min-w-[490px]">
        <h1 className="text-[40px] leading-[56px] font-[800] tracking-[0.1px] text-neutral-white pb-[16px]">
       ...
       <div className="min-w-[540px]">
        <img
         ...
         alt="chef image"
         className="h-[361px] w-[540px] object-cover"
        />
       </div>
      </div>
     </div>
