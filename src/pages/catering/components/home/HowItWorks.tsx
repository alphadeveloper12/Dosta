  ...
  return (
    <section className="pb-[24px] pt-[48px] bg-neutral-white">
      <div className="main-container mx-auto px-4">
        ...
        {/* Steps */}
        <div className="flex flex-col md:flex-row justify-center items-center md:gap-6 gap-4 my-[24px]">
          {steps.map((step, index) => {
            const Icon = step.icon;
            return (
              <div
                key={index}
                className="w-full max-w-[350px] md:h-[276px] md:w-[350px] bg-neutral-white rounded-[16px] p-6 shadow-lg text-center">
        ...
        <div className="text-center">
          <Button variant="default" size="lg" className="!px-[16px]">
            Let's Get Started
          </Button>
        </div>
      </div>
