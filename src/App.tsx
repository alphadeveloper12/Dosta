...
const CateringConfirmation = lazy(
 () => import("./pages/catering/pages/CateringConfirmation"),
);
const RequestCustomQuote = lazy(
 () => import("./pages/catering/pages/RequestCustomQuote"),
);
...
const PageLoader = () => (
 <div className="flex h-screen w-full items-center justify-center bg-white">
  <img src="/animated-icon.svg" alt="Loading..." className="w-16 h-16" />
 </div>
);
