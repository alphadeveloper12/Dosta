...
const steps = [
  {
    ...
    description: "Freshly prepared dishes delivered straight to your home or workspace",
    tag: "DOSTA DELIVERY",
    button: "Browse Menus",
  ...
  },
  {
    ...
    description: "Balanced meal plans tailored for your health goals, delivered or picked up.",
    tag: "DOSTA WELLNESS",
  ...
  },
  {
    ...
    description: "Office catering that's both delicious and professionally executed",
    tag: "DOSTA CORPORATE",
  ...
  },
  {
    ...
    description: "Partner with us to support food drives, community events, and local causes.",
    tag: "DOSTA GIVING",
            ...
            return (
              ...
              >
                ...
                <div className="pt-[32px] px-[24px] pb-[24px]">
                  ...
                  <button
                    onClick={() => handleNavigation(step.link)} // Call handleNavigation on button click
