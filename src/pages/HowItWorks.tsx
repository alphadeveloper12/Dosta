     ...
     <div className="main-container">
      <AnimateOnScroll>
       ...
       <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
        Discover how easy it is to use our platform. From signing up to
        receiving your order, we've streamlined every step for your convenience.
       </p>
      </AnimateOnScroll>
     </div>
    </section>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
       {steps.map((step, index) => (
        <AnimateStaggerItem key={index} index={index}>
         <Card className="text-center hover:shadow-lg transition-shadow border-none shadow-md">
