...
const HeroSection = () => {
  ...
  // Lock scroll when locator sidebar is open
  useEffect(() => {
    if (selectedItem) {
          ...
          <AnimateOnScroll>
            <div className="w-full max-w-[585px] h-auto rounded-2xl bg-white shadow-[0_12px_24px_0_#2B2B4329] py-6 md:py-8 px-5 sm:px-[64px]">
              ...
              <p className="mt-6 text-[20px] leading-[28px]  font-semibold text-center text-[#545563]">
                Plan and reserve your meal and pick it up from a vending location
                nearby.
              </p>
              ...
              <div className="mt-6 text-center">
                <a
                  href="#"
                  className="text-sm text-[#056AC1] font-bold hover:underline">
        ...
        {selectedItem && (
          <motion.div
            ...
            <motion.div
              ...
              {/* List View */}
              {activeView === "list" && (
                <div data-lenis-prevent className="flex-1 overflow-y-auto px-8 space-y-4 py-8">
                  {status === "loading" ? (
                    <Shrimmer />
                  ) : (
                    [...vendingLocations]
